<template>
  <aside class="control-sidebar fixed white hv-100" ref="sidebarRight">
    <div class="sidebar-header">
      <div class="d-flex justify-content-between">
        <h4>Activity List</h4>
        <span @click="close" class="paper-nav-toggle active">
          <i></i>
        </span>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <canvas
            ...
            class="chartjs-render-monitor js-chart-drawn"
            style="display: block; height: 93px; width: 134px;"
          ></canvas>
        </div>
      </div>
    </div>
